...
Life Expectancy Trend (Top 5 Countries)
Line chart showing life expectancy over time

Top 5 countries filtered by highest average life expectancy

Country used for colour coding
...
Country filter added (single‑value dropdown)

Population displayed as percentage of total

Life Expectancy vs BMI
Scatter plot comparing BMI and life expectancy

Country on detail

Continent on colour

Continent filter shown

Dashboard
Combined all worksheets
